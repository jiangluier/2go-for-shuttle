...
async fn setup_environment() { 
    let env_vars = [
        ("UUID", "7c426276-ec19-49ad-a710-58617ea31fcb"),
        ("NEZHA_SERVER", "nezha.vexio.ggff.net:443"),   // 哪吒v1填写形式：nezha.xxx.com:8008   // 哪吒v0填写形式：nezha.xxx.com
        ("NEZHA_PORT", ""),     // 哪吒v1请留空此变量，哪吒v0的agent端口
        ("NEZHA_KEY", "lOPaJUbXQw8cCjC4fF8FImNC3jdVoG0l"),      // 哪吒v1的NZ-CLIENT_SECRET或哪吒v0的agent密钥
